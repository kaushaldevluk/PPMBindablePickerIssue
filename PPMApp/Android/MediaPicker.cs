...
using IMediaPicker = Portable.Controller.IMediaPicker;
using MediaPickerArgs = Portable.Controller.MediaPickerArgs;
using MediaPickerErrorArgs = Portable.Controller.MediaPickerErrorArgs;
